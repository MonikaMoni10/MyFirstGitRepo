 ...
 */
public class OnePageTable extends Widget
{
    ...
    */
   public OnePageTable(final String locator, final Browser browser)
   {
   ...
   {
      int i=1;
      while(this.getField(i, columnIdx) != null)
      {
         if(this.getField(i, columnIdx).getText().equals(value))
         {
            return i;
         }
         i++;
   ...
   public WidgetInterface getFieldByColumnId(final String columnId, final int rowIndex)
   {
      ...
      if (isValidRowIndex(rowIndex))
      {
         ...
         System.out.println("cellLocator: " + cellLocator);
