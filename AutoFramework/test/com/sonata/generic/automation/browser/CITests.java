 ...
 * all unit tests that do not need specialized environments etc. In particular
 * they do not actually open the browsers.
 * <p>
 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({BrowserPackageTestsSuite.class})
